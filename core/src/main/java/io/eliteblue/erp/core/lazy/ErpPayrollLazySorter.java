...
public class ErpPayrollLazySorter implements Comparator<ErpPayroll> {

    private String sortField;
    private SortOrder sortOrder;

    public ErpPayrollLazySorter(String sortField, SortOrder sortOrder) {
        this.sortField = sortField;
        this.sortOrder = sortOrder;
    }

    @Override
    public int compare(ErpPayroll o1, ErpPayroll o2) {
        try {

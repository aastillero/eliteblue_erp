...
@Named
@ViewScoped
public class SilMonitorDetachmentList implements Serializable {
    ...
    public void onRowSelect(SelectEvent<ErpDetachment> event) throws Exception {
        FacesContext.getCurrentInstance().getExternalContext().redirect("sil-monitor-list.xhtml?id="+selectedDetachment.getId());
    }

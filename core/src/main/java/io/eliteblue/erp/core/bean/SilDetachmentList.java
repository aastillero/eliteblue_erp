...
@Named
@ViewScoped
public class SilDetachmentList implements Serializable {
    ...
    public void onRowSelect(SelectEvent<ErpDetachment> event) throws Exception {
        FacesContext.getCurrentInstance().getExternalContext().redirect("sil-list.xhtml?id="+selectedDetachment.getId());
    }

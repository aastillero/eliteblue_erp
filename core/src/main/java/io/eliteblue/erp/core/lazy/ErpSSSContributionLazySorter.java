...
public class ErpSSSContributionLazySorter implements Comparator<ErpSSSContribution> {

    private String sortField;
    private SortOrder sortOrder;

    public ErpSSSContributionLazySorter(String sortField, SortOrder sortOrder) {
        this.sortField = sortField;
        this.sortOrder = sortOrder;
    }

    @Override
    public int compare(ErpSSSContribution o1, ErpSSSContribution o2) {
        try {

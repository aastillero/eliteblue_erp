...
public class ErpHolidayLazySorter implements Comparator<ErpHoliday> {

    private String sortField;
    private SortOrder sortOrder;

    public ErpHolidayLazySorter(String sortField, SortOrder sortOrder) {
        this.sortField = sortField;
        this.sortOrder = sortOrder;
    }

    @Override
    public int compare(ErpHoliday o1, ErpHoliday o2) {
        try {
